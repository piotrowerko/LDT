...
def main():
    ...
    ax.plot(bridge_radar_dyn.time, bridge_radar_dyn.amplitude_envelope, label='envelope')
    LSF_fun_points = bridge_radar_dyn.fun(bridge_radar_dyn.lsq_resutls().x, bridge_radar_dyn.time, 0)
    ax.plot(bridge_radar_dyn.time, LSF_fun_points, label='linear loss')
    softL1_fun_points = bridge_radar_dyn.fun(bridge_radar_dyn.softL1_results().x, bridge_radar_dyn.time, 0)
    ...
    ax.plot(bridge_radar_dyn.time, LSF_fun_points, label='softL1 loss')
    huber_fun_points = bridge_radar_dyn.fun(bridge_radar_dyn.huber_results().x, bridge_radar_dyn.time, 0)
    ...
    ax.plot(bridge_radar_dyn.time, huber_fun_points, label='huber loss')
