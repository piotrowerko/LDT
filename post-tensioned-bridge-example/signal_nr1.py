...
class DynamicSignal():
    ...
    def load_data_in_minutes(self, filePath):
        with open('wl_50.txt') as file_object:
    ...
    def compute_period(self):
        ...
        A_sings = np.sign(self.Amplitude_[:])
    ...
    def compute_envelope(self):
        self.amplitude_envelope = np.abs(hilbert(self.Amplitude))
        self.amplitude_envelope_cutted = self.amplitude_envelope[int(0.02 * len(self.amplitude_envelope)):int(0.90 * len(self.amplitude_envelope))] # docinka 
